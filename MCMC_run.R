...
#k1    <- rtruncnorm(5000, mean=0.8, sd=(0.8*error_h), a=0.8-limits_h, b=0.8+limits_h)
k2    <- rtruncnorm(5000, mean=0.00605, sd=(0.00605*error_h), a=0.00605-limits_h, b=0.00605+limits_h)

h_S     <- rtruncnorm(5000, mean=0.15, sd=(0.15*error_h), a=0.15-limits_h, b=0.15+limits_h)
h_R     <- rtruncnorm(5000, mean=0.35, sd=(0.35*error_h), a=0.35-limits_h, b=0.35+limits_h)
